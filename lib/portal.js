...
conflate(Portal.prototype, {
  ...
  createGnipFeatureService: function (name) {
    var fsTemplate = require('../templates/feature-service.json');
    var layersTemplate = require('../templates/gnip-layer.json');

    return this.createFeatureService(name, fsTemplate, layersTemplate);
  },
  createFeatureService: function (name, serviceDefinition, layersDefinition) {
